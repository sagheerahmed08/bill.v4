...
const PaymentOptions = ({ customerInfo, handleCustomerInfoChange, darkMode }) => {
  const paymentMethods = [
    ...
    { value: 'RAZORPAY', label: 'Razorpay (Cards, UPI, etc.)', icon: CreditCard },
    { value: 'CARD_SWIPE', label: 'Card Swipe Machine', icon: Landmark },
    { value: 'UPI_MANUAL', label: 'UPI (Manual Entry)', icon: Smartphone },
  ];
